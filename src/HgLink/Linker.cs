    ...
    public static class Linker
    {
        ...
        public static int Link(Context context)
        {
            ...
            using (var temporaryFilesContext = new TemporaryFilesContext())
            {
                ...
                ResourceHelper.ExtractEmbeddedResource("HgLink.Resources.Files.pdbstr.exe", pdbStrFile);
                ...
                try
                {
                    ...
                    if (provider == null)
                    {
                        throw Log.ErrorAndCreateException<HgLinkException>("Cannot find a matching provider for '{0}'", context.TargetUrl);
                    }
