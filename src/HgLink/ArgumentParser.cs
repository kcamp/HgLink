...
namespace HgLink
{
    ...
    public static class ArgumentParser
    {
        ...
        public static Context ParseArguments(List<string> commandLineArguments, IProviderManager providerManager)
        {
            ...
            {
                throw Log.ErrorAndCreateException<HgLinkException>("Invalid number of arguments");
            }
            ...
            for (var index = 0; index < namedArguments.Count; index++)
            {
                ...
                throw Log.ErrorAndCreateException<HgLinkException>("Could not parse command line parameter '{0}'.", name);
            }
